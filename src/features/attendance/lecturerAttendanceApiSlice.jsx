  ...
  endpoints: (builder) => ({
    getLecturerAttendance: builder.query({
      ...
      transformResponse: (responseData) => {
        ...
        return lecturerAttendanceAdapter.setAll(
          initialState,
          loadedLecturerAttendance
        );
      },
...
export const selectLecturerAttendanceResult =
  lecturerAttendanceApiSlice.endpoints.getLecturerAttendance.select();
...
} = lecturerAttendanceAdapter.getSelectors(
  (state) => selectLecturerAttendanceData(state) ?? initialState
);
